...
var app = (function () {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$8, 160, 16, 4919);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*term_logs*/ 2 && t_value !== (t_value = /*log*/ ctx[11] + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(160:12) {#each term_logs as log}",
    		ctx
    	});
    ...
    function create_fragment$d(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*term_logs*/ ctx[1];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$8, 158, 8, 4839);
    			attr_dev(div0, "class", "logs svelte-i3ue97");
    			add_location(div0, file$8, 157, 4, 4812);
    			attr_dev(input, "class", "svelte-i3ue97");
    			add_location(input, file$8, 165, 4, 4984);
    			attr_dev(div1, "class", "terminal svelte-i3ue97");
    			add_location(div1, file$8, 156, 0, 4785);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*term_logs*/ 2) {
    				each_value = /*term_logs*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	const COMMAND_LIB = {
    		help: () => {
    			logs.update(l => [...l, ""]);
    			logs.update(l => [...l, "==============K-MEANS CLUSTERING=============="]);
    			logs.update(l => [...l, ""]);
    			logs.update(l => [...l, "help"]);
    			logs.update(l => [...l, "Show this help"]);
    			logs.update(l => [...l, "assign"]);
    			logs.update(l => [...l, "Assign each observation to the cluster with the nearest mean."]);
    			...
    			logs.update(l => [...l, "fit"]);
    			logs.update(l => [...l, "Repeat assign and update until the assignments no longer change."]);
    		},
    		assign: () => {
    			dispatch("assign");
    		},
    	...
    	function Excute() {
    		...
    		if (command.slice(0, 3) == "set") {
    			...
    			if (commands[1] == "--help") {
    				...
    				logs.update(l => [...l, `Set the amount data for each label (10<n<100)`]);
    				logs.update(l => [...l, `set error <n>`]);
    				logs.update(l => [...l, `Set the error range for data from center point (0<n<50)`]);
    				return;
    			}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("term_logs" in $$props) $$invalidate(1, term_logs = $$props.term_logs);
    		if ("logs_list" in $$props) $$invalidate(2, logs_list = $$props.logs_list);
    	...
    	return [command, term_logs, logs_list, onKeyPress, ul_binding, input_input_handler];
    }
    ...
    */
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(233:12) {#each data as point}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(245:12) {#each labels as label}",
    		ctx
    	});
    ...
    // (225:8) <Graphic             width={500}             height={500}             scaleX={[-6, MAX + 6]}             scaleY={[-6, MAX + 6]}             flipY             padding={20}         >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(225:8) <Graphic             width={500}             height={500}             scaleX={[-6, MAX + 6]}             scaleY={[-6, MAX + 6]}             flipY             padding={20}         >",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 223, 4, 5552);
    			attr_dev(div1, "class", "controller svelte-31asw4");
    			add_location(div1, file, 280, 4, 7292);
    			attr_dev(main, "class", "svelte-31asw4");
    			add_location(main, file, 222, 0, 5541);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function Assignment() {
    		...
    		for (let i = 0; i < LABELS_AMOUNT; i++) {
    			logs.update(l => [...l, `Label ${i} now contain ${contain[i]} points`]);
    		}
    	...
    	function Fit() {
    		...
    		let fit = setInterval(
    			() => {
    				...
    				if (!change) {
    					logs.update(l => [...l, `Fitted after ${interval} interation(s)`]);
    					clearInterval(fit);
    				}
    			},
    			2000
