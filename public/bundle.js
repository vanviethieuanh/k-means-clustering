    ...
    */
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(232:12) {#each data as point}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(244:12) {#each labels as label}",
    		ctx
    	});
    ...
    // (224:8) <Graphic             width={500}             height={500}             scaleX={[-6, MAX + 6]}             scaleY={[-6, MAX + 6]}             flipY             padding={20}         >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(224:8) <Graphic             width={500}             height={500}             scaleX={[-6, MAX + 6]}             scaleY={[-6, MAX + 6]}             flipY             padding={20}         >",
    		ctx
    	});
