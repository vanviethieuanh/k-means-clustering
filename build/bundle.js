    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			attr_dev(li, "class", "svelte-1w22tgn");
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			input = element("input");
    			attr_dev(ul, "class", "svelte-1w22tgn");
    			add_location(ul, file$8, 170, 8, 5123);
    			attr_dev(div0, "class", "logs svelte-1w22tgn");
    			add_location(div0, file$8, 169, 4, 5096);
    			attr_dev(p, "class", "svelte-1w22tgn");
    			add_location(p, file$8, 182, 8, 5401);
    			attr_dev(input, "class", "svelte-1w22tgn");
    			add_location(input, file$8, 183, 8, 5422);
    			attr_dev(div1, "class", "prompt svelte-1w22tgn");
    			add_location(div1, file$8, 181, 4, 5372);
    			attr_dev(div2, "class", "terminal svelte-1w22tgn");
    			add_location(div2, file$8, 168, 0, 5069);
    		},
...
return d[d.length-1];};return ", funcName].join("");
    ...
    */
    ...
    function create_each_block_1(ctx) {
    	...
    	point = new Point({
    			props: {
    				...
    				y: /*point*/ ctx[25].y,
    				radius: 2,
    				fill: /*point*/ ctx[25].label == -1
    				? "#8B8B8B"
    				: /*labels*/ ctx[1][/*point*/ ctx[25].label].color,
    				opacity: 0.9,
    				transition: 2000
    			},
    			$$inline: true
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const point_changes = {};
    			if (dirty & /*data*/ 4) point_changes.x = /*point*/ ctx[25].x;
    			if (dirty & /*data*/ 4) point_changes.y = /*point*/ ctx[25].y;

    			if (dirty & /*data, labels*/ 6) point_changes.fill = /*point*/ ctx[25].label == -1
    			? "#8B8B8B"
    			: /*labels*/ ctx[1][/*point*/ ctx[25].label].color;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(238:12) {#each data as point}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*labels*/ 2) point0_changes.x = /*label*/ ctx[22].x;
    			if (dirty & /*labels*/ 2) point0_changes.y = /*label*/ ctx[22].y;
    			if (dirty & /*labels*/ 2) point0_changes.fill = /*label*/ ctx[22].color;
    			point0.$set(point0_changes);
    			const point1_changes = {};
    			if (dirty & /*labels*/ 2) point1_changes.x = /*label*/ ctx[22].x;
    			if (dirty & /*labels*/ 2) point1_changes.y = /*label*/ ctx[22].y;
    			if (dirty & /*labels*/ 2) point1_changes.stroke = /*label*/ ctx[22].color;
    			if (dirty & /*labels*/ 2) point1_changes.fill = /*label*/ ctx[22].color;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(250:12) {#each labels as label}",
    		ctx
    	});
    ...
    // (230:8) <Graphic             width={canvasSize}             height={canvasSize}             scaleX={[-6, MAX + 6]}             scaleY={[-6, MAX + 6]}             flipY             padding={20}         >
    function create_default_slot(ctx) {
    	...
    	xaxis = new XAxis({
    			props: {
    				baseLineColor: /*GRID_COLOR*/ ctx[3],
    				tickColor: /*GRID_COLOR*/ ctx[3],
    				labelColor: /*GRID_COLOR*/ ctx[3],
    				labelOpacity: 0
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(230:8) <Graphic             width={canvasSize}             height={canvasSize}             scaleX={[-6, MAX + 6]}             scaleY={[-6, MAX + 6]}             flipY             padding={20}         >",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	graphic = new Graphic({
    			props: {
    				width: /*canvasSize*/ ctx[0],
    				height: /*canvasSize*/ ctx[0],
    				scaleX: [-6, /*MAX*/ ctx[4] + 6],
    				scaleY: [-6, /*MAX*/ ctx[4] + 6],
    				flipY: true,
    				padding: 20,
    	...
    	terminal.$on("assign", /*Assignment*/ ctx[7]);
    	terminal.$on("update", /*Update*/ ctx[6]);
    	terminal.$on("fit", /*Fit*/ ctx[8]);
    	terminal.$on("setLabel", /*setLabel*/ ctx[9]);
    	terminal.$on("setData", /*setData*/ ctx[10]);
    	terminal.$on("setError", /*setError*/ ctx[11]);
    	terminal.$on("reset", /*Reset*/ ctx[12]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 228, 4, 5700);
    			attr_dev(div1, "class", "controller");
    			add_location(div1, file, 285, 4, 7454);
    			attr_dev(main, "class", "svelte-jj789r");
    			add_location(main, file, 227, 0, 5689);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(window_1, "resize", /*graphSize*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			const graphic_changes = {};
    			if (dirty & /*canvasSize*/ 1) graphic_changes.width = /*canvasSize*/ ctx[0];
    			if (dirty & /*canvasSize*/ 1) graphic_changes.height = /*canvasSize*/ ctx[0];

    			if (dirty & /*$$scope, labels, data*/ 268435462) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const graphSize = function () {
    		$$invalidate(0, canvasSize = Math.min(window.innerWidth, window.innerHeight) - 20);
    	...
    	function setLabel(e) {
    		...
    		if (LABELS_AMOUNT > num) {
    			...
    			$$invalidate(1, labels = labels.slice(0, num));
    		} else {
    	...
    	function setError(e) {
    		const num = e.detail.num;
    		ERROR = num;
    		$$invalidate(2, data = generateData(N_FOR_LABEL, centers));
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("canvasSize" in $$props) $$invalidate(0, canvasSize = $$props.canvasSize);
    		if ("GRID_COLOR" in $$props) $$invalidate(3, GRID_COLOR = $$props.GRID_COLOR);
